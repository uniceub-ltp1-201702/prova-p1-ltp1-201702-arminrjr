...
public class BDSimulado {
    ...
    //Questao 2a
	public String InfoCliente(String nomeCliente){
		String resultado = "";
		...
		for (int i = 0; i < this.clientes.size(); i++) {
			if (this.clientes.get(i).getNome().equals(nomeCliente)) {
				...
				"Data de Nasciemnto: " + this.clientes.get(i).getNascimento()+ "\n" +
				"Numero: " + this.clientes.get(i).getNumero()+ "\n" +
	...
	//Questao 2b
	public ArrayList<Ligacao> ligacoesPorCliente(String ligacaoCliente){
		ArrayList<Ligacao> resultado = new ArrayList<Ligacao>();
		
		for (int i = 0; i < this.ligacoes.size(); i++) {
			if (this.ligacoes.get(i).getCliente().getNome().equals(ligacaoCliente)) {
